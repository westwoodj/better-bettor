...
### See data/espn/casinos.yml for a more complete list of providers.
...
| Event Prop Bets                  | `sports.core.api.espn.com` | `/v2/sports/{sport}/leagues/{leagues}/events/{event_id}/competitions/{comp_id}/odds/{casino_id}/propBets` | `sport`, `league`, `event_id`, `comp_id`, `casino_id`, `limit` | `.../limit=1000&lang=en&region=us` (event_id and comp_id are the same for single NFL games) | [7]        |
...
| Weather Forecast       | `sports.core.api.espn.com` | `/v2/weather/zip/{zip_code}`                                                     | `{date}`,`{hour}` example: `.../zip/30313?date=20251013&hour=19` | Get weather forecast information for zipcode at given time. return body has a link.href string that redirects to accuweather.com page |            |
